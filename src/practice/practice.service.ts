  ...
  async generateSentence(
    ...
    const res = await this.openAi.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `Сгенерируй случайное предложение (не используй слово кот) (используй все возможные слова) интерессное и смысловое, без фантастики, на ${lang} языке, затем напиши перевод этого текста на русский, раздели их знаком |;
